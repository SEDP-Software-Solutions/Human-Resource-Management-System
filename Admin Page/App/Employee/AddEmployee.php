            ...
            <form action="../Dao/Employee-db/AddEmployee_db.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="tel" class="form-control" name="ContactNumber" pattern="[0-9]{11}" inputmode="numeric" value="<?php echo htmlspecialchars($ContactNumber); ?>" maxlength="11" required>
                    </div>
